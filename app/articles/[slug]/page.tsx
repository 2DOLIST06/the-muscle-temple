  ...
  return (
    <Container>
      <article className="py-10">
        ...
        <div className="mt-8"><AffiliateDisclosureNotice locale="en" /></div>
          ...
          <div className="space-y-8">
            {post.chapoHtml ? (
              <div className="rounded-2xl border-l-4 border-amber-400 bg-amber-50 px-6 py-5 text-lg leading-8 text-slate-800">
                <RichContentRenderer contentHtml={post.chapoHtml} locale="en" />
              </div>
            ) : null}
            {post.contentHtml ? <RichContentRenderer contentHtml={post.contentHtml} locale="en" /> : post.sections.map((section) => {
